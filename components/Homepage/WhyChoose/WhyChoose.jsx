        ...
        <div className="whyChooseTab flex alignCenter justifyCenter spaceBtw marginBottom1">
          <div className="whyChooseBox width49 flex flexColumn alignStart justifyCenter">
            ...
            <p>
              ...
              you to understand your goals and design programs that are
              outcome-centric, ensuring that you get the most value out of your
              investment.
            </p>
          </div>
          <div className="whyChooseBox width49 flex flexColumn alignStart justifyCenter">
            ...
            <p>
              ...
              your specific needs. Our expert trainers and consultants work with
              you to design programs that address your specific challenges and
              goals, ensuring maximum impact.
            </p>
          </div>
        </div>
        <div className="whyChooseTab flex alignCenter justifyCenter spaceBtw marginBottom1">
          <div className="whyChooseBox width49 flex flexColumn alignStart justifyCenter">
            ...
            <p>
              ...
              effectiveness of our programs and help you track your progress.
            </p>
          </div>
          <div className="whyChooseBox width49 flex flexColumn alignStart justifyCenter">
            <h4>
            ...
            <p>
              ...
              what you've learned to your work and achieve your desired
              outcomes.
            </p>
          </div>
        </div>
        <div className="whyChooseTab flex alignCenter justifyCenter spaceBtw marginBottom1">
          <div className="whyChooseBox width49 flex flexColumn alignStart justifyCenter">
            ...
            <p>
              ...
              personalized approach to learning allows you to focus on areas
              that are most relevant to your personal and professional growth.
            </p>
          </div>
          <div className="whyChooseBox width49 flex flexColumn alignStart justifyCenter">
            <h4>
